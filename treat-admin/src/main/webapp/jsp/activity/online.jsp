...
<html>
    ...
    <form id="searchForm" class="form-horizontal" tabindex="0" style="margin:50px 20px 20px 20px;"  enctype="multipart/form-data">
    	<table cellpadding="0"   cellspacing="0" border="0" width="100%" height="100%">
    		...
    		<tr class="tr-height">
    			<td class="td-right">请客类型：</td>
    			<td >
    				<select name="type" id="type" >
    					<option value="">全部约会</option>
						<option value="0">请好友</option>
						<option value="1">向我要</option>
						<option value="2">大家抢</option>
					</select>
    			</td>
				<td class="td-right">请客状态：</td>
    			<td >
	...
	<script type="text/javascript">
	    ...
	    columns = [
	    	    {title:'请客Id',dataIndex:'id',width:40,elCls : 'center'},
	    	    {title:'用户Id',dataIndex:'userId',width:40,elCls : 'center'},
	    	    {title:'请客类型',dataIndex:'type',width:40,elCls : 'center',renderer:BUI.Grid.Format.enumRenderer({"0":"请好友","1":"向我要","2":"大家抢"})},
				{title:'活动主题',dataIndex:'theme',elCls : 'center'},
				{title:'请客状态',dataIndex:'activeState',width:40,elCls : 'center',renderer:BUI.Grid.Format.enumRenderer({"1":"未激活","2":"进行中","3":"已结束"})},
	    	    /* {title:'付费方式',dataIndex:'paymentWay',width:40,elCls : 'center',renderer:BUI.Grid.Format.enumRenderer({"1":"我请","2":"AA","3":"男A"})}, */
				...
				--%>
				{title:'审核状态',dataIndex:'status',width:40,elCls : 'center',renderer:BUI.Grid.Format.enumRenderer({"1":"未审核","2":"审核通过","3":"审核通不过"})},
				//{title:'发布时间',dataIndex:'ctime',width:45,renderer:BUI.Grid.Format.datetimeRenderer,elCls : 'center'},
	    ...
	    var store = new Store({
	    url :'${basePath}/activity/getOnlineList.do',
	    autoLoad:true,
	    params : {         //设置请求时的参数
	      id : '${param.id}'
	    },
