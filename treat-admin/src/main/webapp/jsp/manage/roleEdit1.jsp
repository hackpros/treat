     ...
     <input name="id" type="hidden" value="${id}">
      ...
      <div class="row">
      	  <div class="control-group span12">
	          ...
	          <div class="controls">
					<input name="roleName" type="text" value="${roleName}" title="角色名称" alt="notnull;" maxlength="35">
  ...
  <script type="text/javascript">
    ...
    function checkInput() {
		...
		if("${id}"==0){
			...
			document.submitForm.action = "${basePath}/updateUserRole.do";   
		}
