     ...
     <input name="id" type="hidden" value="${userManager.id}">
        ...
        <div class="control-group span12">
	          <div class="controls">
				<c:if test="${userManager.pass_word==null }">
					...
					<input name="pass_word" type="password" maxlength="8" title="密码" alt="notnull;" id="pass">
				</c:if>
	          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="birthday" value="${userManager.birthday}"  type="text"  title="出生日期" alt="notnull;"  class="calendar" style="width:140px;"  readonly="readonly">
          </div>
        </div>
