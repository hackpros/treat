...
<html>
	...
	<body>
        ...
        BUI.use(['bui/grid','bui/data'],function(Grid,Data){
          ...
          columns = [
            {title:'id',dataIndex:'id',width:10,elCls : 'center'},
      	    {title:'角色',dataIndex:'roleName',width:100,elCls : 'center'},
          ];
        ...
        var editing = new Grid.Plugins.DialogEditing({
          ...
          store = new Store({
            url : '${basePath}/getUserRoleList.do',
            autoLoad:true,
            pageSize:10,
		    root : 'rolelist',
		     totalProperty : 'total',
        ...
        function delFunction(){
          ...
          if(selections.length<1){
				...
				ids += selections[selections.length-1].id;
				 jQuery.post('${basePath}/deleteRole.do',{ids:ids},function(data){
		              if(data.result==1){
		             	alert("删除成功");
		             	store.load(); 
		             }else{
		             	alert("id为"+data.result+"的角色正在使用中！");
		             	store.load();
		             }
				});
			}
