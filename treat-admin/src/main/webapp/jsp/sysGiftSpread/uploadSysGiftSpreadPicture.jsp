        ...
        function upload(){ 
	    	if($("#img").val()==""){
	    		...
	    		return false;
	  			...
	  			var url = "${basePath}/sysGiftSpread/uploadSysGiftSpreadPic.do?id="+$("#id").val()+'&picType='+$("#picType").val();
			   	document.coverForm.action = url;
		...
		$(document).ready(function(e) {
	    	...
	    	jQuery.post('${basePath}/sysGiftSpread/getSysGiftSpreadInfo.do',{id:id},function(data){
	    	    if(data){
	    	     	...
	    	     	if(picType == "coverImg"){
		    	     	$("#oldImghead").attr("src",data.coverImg);
	    	     	}else if(picType == "bigImg"){
	    	     	 	$("#oldImghead").attr("src",data.bigImg);
	    	     	}
		    	}
			});
	    });
...
<body>
	<form name="coverForm" action="" method="post"
		enctype="multipart/form-data" id="coverForm">
		<div style="display:none">
			<input id="id" name="id" value="${param.id}" />
			<input id="picType" name="picType" value="${param.picType}" />
		</div>
