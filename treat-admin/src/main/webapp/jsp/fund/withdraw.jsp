...
<body>
	...
	<script type="text/javascript">
	    ...
	    columns = [
	          ...
	          {title:'手机号',dataIndex:'mobile',width:30,elCls : 'center'},
	          {title:'昵称',dataIndex:'nickName',width:30,elCls : 'center'},
	          ...
	          {title:'申请时间',dataIndex:'ctime',width:60,renderer:BUI.Grid.Format.datetimeRenderer,elCls : 'center'},
	          {title:'提现状态',dataIndex:'withdrawStatus',width:60,elCls : 'center',renderer:BUI.Grid.Format.enumRenderer({"1":"未提现","2":"已提现"})},
	    ...
	    var store = new Store({
	    url :'${basePath}/fund/getWithdrawList.do',
	    autoLoad:true,
	    pageSize:50,
	      root : 'withdrawList',
	      totalProperty : 'total',
		...
		function jqPost(ids, withdrawStatus){
			jQuery.post('${basePath}/fund/updateWithdrawStatus.do',{ids:ids,withdrawStatus:withdrawStatus},function(data){
	             if(data){
		             alert("已标记为已提现！");
		             store.load();
		         }
