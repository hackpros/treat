package com.navigate.treat.oss;
...
public class Sts {
	...
	// 目前只有"cn-hangzhou"这个region可用, 不要使用填写其他region的值
	  ...
	  public static void main(String[] args) {
	    ...
	    String accessKeyId = "o2gSSd0qzzriYYAv";
	    String accessKeySecret = "AP6wFSm8tRMVfdVJeDuuKLXDZ4ruIp";

	    // AssumeRole API 请求参数: RoleArn, RoleSessionName, Polciy, and DurationSeconds

	    // RoleArn 需要在 RAM 控制台上获取
	    String roleArn = "acs:ram::1865650772930441:role/tupianfangwen";

	    // RoleSessionName 是临时Token的会话名称，自己指定用于标识你的用户，主要用于审计，或者用于区分Token颁发给谁
	    // 但是注意RoleSessionName的长度和规则，不要有空格，只能有'-' '_' 字母和数字等字符
	    // 具体规则请参考API文档中的格式要求
	    String roleSessionName = "kevin";
