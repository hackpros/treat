...
public class ActCommentUsersRes  implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -511480541622279243L;
	/**
	 * 活动Id
	 */
	 ...
	 * 评论标签
	 */
	private List<Integer> commentType=new ArrayList<Integer>();
	...
	public Long getCommentUerId() {
		return commentUerId;
	}
	public void setCommentUerId(Long commentUerId) {
		this.commentUerId = commentUerId;
	}
	...
	public List<Integer> getCommentType() {
		return commentType;
	}
	public void setCommentType(List<Integer> commentType) {
